<?php /* Smarty version 2.6.18, created on 2013-12-20 18:23:06
...
<h1>节目搜索结果</h1><h2><a style="color:red;" href="http://search.xinvalue.com"><=返回搜索页面</a></h2>
...
"/>
    ...
    <div>
        <img src="<?php echo $this->_tpl_vars['show']->poster; ?>
" alt="" title=""/>
...
次，评分<?php echo $this->_tpl_vars['show']->score; ?>
    ...
    <iframe id="iFrame1" name="iFrame1" width="100%" onload="this.height=iFrame1.document.body.scrollHeight"
            frameborder="0" src="http://www.xinvalue.com/ckplayer/info/search_playlist.php?pid=<?php echo $this->_tpl_vars['show']->id; ?>
"></iframe>

    <a href="http://search.xinvalue.com/go/?kw=<?php echo $this->_tpl_vars['show']->paly_link; ?>
" target="_blank">
...
?>
  ...
  <div>
      <a href="http://search.xinvalue.com/go/?kw=<?php echo $this->_tpl_vars['video']->link; ?>
"
         target="_blank">

<?php /* Smarty version 2.6.18, created on 2013-12-22 01:32:34
         compiled from index.html */ ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html lang="en">
<head>
<head >
    <script async="" src="playFiles/ex_002.js"></script>
    <script src="playFiles/main.js" charset="utg-8"></script>
    <script src="playFiles/beacon.js" async=""></script>
    <script src="playFiles/qa.js" async=""></script>
    <script src="playFiles/hm.js"></script>
    ...
    <!--
      视频播放|新价值网-做有思想的IT博客
        ...
        -->
    <link rel="shortcut icon" href="http://localhost/favicon.ico" type="image/icon">
    <link rel="stylesheet" type="text/css" href="playFiles/basic_other.css">
    <link rel="stylesheet" type="text/css" href="playFiles/play_new.css">
    <!--顶部引用脚本-->
    <script type="text/javascript" src="playFiles/sea1.js"></script>

    <script src="playFiles/ver.js" async="" charset="utf-8"></script>
    <script charset="utf-8" type="text/javascript" src="playFiles/iwt.js"></script>
    <script src="playFiles/setPlay.js" async="" charset="utf-8"></script>
...
<div class="crumbWrap-black">
    <div class="gui_TopInfo crumb_bar">
        <div class="topInfoC_add" style="left: -6px; margin-left: -50px; top: 0px;">
            <!--旗帜广告新修改-->
            <a href="http://localhost" target="_blank" title="新价值网|做有思想的IT博客"> <img src="logo.png"
                        ...
                        <script type="text/javascript">
                            ...
                            $("#get_title").click(function(){
                               if($(document).attr("title")==""){
                                   ...
                                   alert("当前已是获取最新标题，无须重新获取！");
                               }
                            });
                            function ajax_get_title(){
                                $.ajax({
                                    type: "GET",
                                    url: "./info/video_title.php",
                                    dataType: "html",
                                    data: "url="+$("#vurl").val(),
...
<span>开发,大家有什么意见建议，欢迎<a
                                        style="color: yellowgreen" href="http://localhost/aboutme/#respond"
    ...
    <div class="vdoContent videoExpand" id="j-video-box" style="position: relative;" data-widget-switchlight="light">
        ...
        <div class="videoPlay medium">
            <div id="flashbox" class="vdoPlayer padplay0108" style="height: 520px; position: relative; width: 980px;">
                ...
                <script type="text/javascript" src="http://localhost/ckplayer/ckplayer.js"></script>
                <script type="text/javascript">
                    var flashvars={
...
//视频列表0关，1开
                    ...
                    CKobject.embedSWF("http://localhost/ckplayer/ckplayer.swf","a1","ckplayer_a1","980","520",flashvars,params);
...
<!--视频信息-->
                  <iframe id="iFrame1" style="margin-top:-28x;height:175px;" name="iFrame1" width="100%"  frameborder="0" src="http://localhost/ckplayer/info/info.php?url=<?php echo $this->_tpl_vars['vurl']; ?>
"></iframe>
<!--评论-->
                  <iframe id="comments" style="margin-top:-18x;height:1400px;" name="comments" width="100%" frameborder="0" src="http://localhost/ckplayer/info/comments.php?url=<?php echo $this->_tpl_vars['vurl']; ?>
"    ></iframe>                

 ...
 * 视频地址
 */
$f = 'http://localhost/ckplayer/video.php?url=' . $de_key;
...
//print_r($urls);
    $vid = $urls["filename"];
    $f = 'http://localhost/ckplayer/watch/play.php?vtype=' . $vtype . '&vid=' . $vid;
//$f=urlencode($f);
    ...
    'http://localhost/ckplayer/video.php?url=' . $de_key;
}
//echo '<br/>'.$vid.'<br/>';
/////////////插件切换结束////////////////
$tpl->assign("f", $f);
 ...
 * cq_010ecbc6bffc4affa5db81a2d96c5d8a_qiyi}{f->http://localhost/ckplayer/video.php?url=[$pat2]}
 * </flashvars>
 ...
 * 修改标题
 */
//$fp=fopen('http;//localhost/ckplayer/url.php?url='.$url,'r');
//$result="";
//while(!feof($fp)){

...
function ckcpt() {
    ...
    //cpt += 'list_btn.swf,0,2,110,-30,2,1|';//分享插件
    cpt += 'downloadspeeds.swf,0,2,150,-24,2,0|';//下载速度
    return cpt;
}
/*
 插件的定义结束
...
function ckstyle() { //定义总的风格
    var ck = {
        ...
        /*
         ...
         以下是播放器自带的二个插件
         */
        control_rel: 'related.swf,http://localhost/ckplayer/related.php?id=[$pat],0',
        //control_list_pic:'list_pic.swf,http://www.7evs.com/index.php?r=playlist/lists/15,0',
        /*
         视频结束显示精彩视频的插件
         ...
         */
        cpt_share: 'http://localhost/ckplayer/share.xml',
        /*
         分享插件调用的配置文件地址
         调用插件开始
         */

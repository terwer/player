<?php /* Smarty version 2.6.18, created on 2013-12-21 17:51:11
...
次，评分<?php echo $this->_tpl_vars['show']->score; ?>
    ...
    <iframe id="iFrame1" name="iFrame1" width="100%" onload="this.height=iFrame1.document.body.scrollHeight"
            frameborder="0" src="http://localhost/ckplayer/info/search_playlist.php?pid=<?php echo $this->_tpl_vars['show']->id; ?>
"></iframe>

    <a href="http://localhost/search/go/?kw=<?php echo $this->_tpl_vars['show']->paly_link; ?>
" target="_blank">

<%@ page language="java" contentType="text/xml; charset=UTF-8"
         pageEncoding="UTF-8" isELIgnored="false" %><?xml version="1.0" encoding="utf-8"?>
<ckplayer>
    <share_html>
        {embed src="${siteConfig.ckplayerHome}/ckplayer/ckplayer.swf" flashvars="[$share]" quality="high" width="480"
    ...
    <share_path>${siteConfig.ckplayerHome}/ckplayer/share/</share_path>
    <!--分享图片的文件夹地址-->
    <share_replace>
    </share_replace>

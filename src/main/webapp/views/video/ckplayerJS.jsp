<%@ page contentType="application/javascript;charset=UTF-8" language="java" isELIgnored="false" %>
/*
-------------------------------------------------------------------------
说明:
...
//分享xml路径
var share_url='${siteConfig.playerUrl}/video/shareXml.do';
var laguage_url='${siteConfig.ckplayerHome}/language.xml';
var related_url='${siteConfig.playerUrl}/video/relatedXml.do';
/**************************************************************************/
/*
第一部分，加载插件
以下为加载的插件部份

...
-------------------------------------------------------------------------
  说明:
  player,有问题请访问http://www.ckplayer.com
...
function ckcpt(){
	...
	cpt += 'adjustment.swf,1,1,-10,-10,3,0|';//调整大小和颜色的插件
...
function ckstyle() { //定义总的风格
	...
	*/
	...
	以下是播放器自带的二个插件
	*/
	control_rel:'related.swf,http://localhost/player/ckplayer/related.php?id=[$pat],0',
	control_list_pic:'list_pic.swf,http://localhost/player/ckplayer/list_mov.php?r=playlist/lists/,0',
	/*
	视频结束显示精彩视频的插件
	...
	*/
	cpt_share:'http://localhost/player/ckplayer/share.xml',
	/*
	分享插件调用的配置文件地址
	调用插件开始
	*/

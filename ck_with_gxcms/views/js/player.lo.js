...
var Player = {
	...
	'ckplayer' : function(){
		...
		html='<embed src="http://localhost/ckplayer/ckplayer.swf" flashvars="a='+encodeURIComponent(array["url"])+'&my_url='+encodeURIComponent(window.location.href)+'&e='+_nextu+'" quality="high" width="'+this.Width+'" height="'+this.Height+'" align="middle" allowScriptAccess="always" allowFullscreen="true" type="application/x-shockwave-flash"></embed>';
		//qq.com特殊处理（沿用旧的接口）
		...
		//alert(vid);
		//alert("aaa");
		html='<embed src="http://localhost/ckplayer/ckplayer.swf" flashvars="f=http://localhost/ckplayer/watch/play.php'+encodeURIComponent("?vtype=qq&vid="+vid)+'&a='+encodeURIComponent(array["url"])+'&my_url='+encodeURIComponent(window.location.href)+'&e='+_nextu+'" quality="high" width="'+this.Width+'" height="'+this.Height+'" align="middle" allowScriptAccess="always" allowFullscreen="true" type="application/x-shockwave-flash"></embed>';
		}else if(array["url"].substring(7,17)=="tv.cntv.cn"){
		//alert(array["url"].substring(7,17)=="tv.cntv.cn");
		var vid=array["url"].split('/')[5];
		//alert(vid);
		html='<embed src="http://localhost/ckplayer/ckplayer.swf" flashvars="f=http://localhost/ckplayer/watch/play.php'+encodeURIComponent("?vtype=cntv&vid="+vid)+'&a='+encodeURIComponent(array["url"])+'&my_url='+encodeURIComponent(window.location.href)+'&e='+_nextu+'" quality="high" width="'+this.Width+'" height="'+this.Height+'" align="middle" allowScriptAccess="always" allowFullscreen="true" type="application/x-shockwave-flash"></embed>';
		}

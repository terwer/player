...
var Player = {
	...
	'ckplayer' : function(){
		...
		html='<embed src="http://localhost/ckplayer/ckplayer.swf" flashvars="a='+encodeURIComponent(array["url"])+'&my_url='+encodeURIComponent(window.location.href)+'&e='+_nextu+'&kai=1" quality="high" width="'+this.Width+'" height="'+this.Height+'" align="middle" allowScriptAccess="always" allowFullscreen="true" type="application/x-shockwave-flash"></embed>';
		//qq.com特殊处理（沿用旧的接口）
